//  server/src/routes/dataFetchingRoutes/dailyVisitReports.ts 
// Daily Visit Reports DELETE endpoints using createAutoCRUD pattern
...
export default function setupDailyVisitReportsDeleteRoutes(app: Express) {
  // Daily Visit Reports DELETE endpoints
  createAutoCRUD(app, {
